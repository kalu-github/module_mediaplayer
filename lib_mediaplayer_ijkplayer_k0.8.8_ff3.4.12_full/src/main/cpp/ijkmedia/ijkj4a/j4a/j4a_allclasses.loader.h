...
J4A_LOAD_CLASS(lib_kalu_ijkplayer_misc_IMediaDataSource);
J4A_LOAD_CLASS(lib_kalu_ijkplayer_misc_IAndroidIO);
J4A_LOAD_CLASS(lib_kalu_ijkplayer_IjkMediaPlayer);
