...
jint J4AC_android_os_Build__VERSION__SDK_INT__get(JNIEnv *env) {
    return (*env)->GetStaticIntField(env, class_J4AC_android_os_Build__VERSION.id,
                                     class_J4AC_android_os_Build__VERSION.field_SDK_INT);
}
...
void J4AC_android_os_Build__VERSION__SDK_INT__set(JNIEnv *env, jint value) {
    (*env)->SetStaticIntField(env, class_J4AC_android_os_Build__VERSION.id,
                              class_J4AC_android_os_Build__VERSION.field_SDK_INT, value);
}
...
int J4A_loadClass__J4AC_android_os_Build__VERSION(JNIEnv *env) {
    ...
    name = "SDK_INT";
    sign = "I";
    class_J4AC_android_os_Build__VERSION.field_SDK_INT = J4A_GetStaticFieldID__catchAll(env,
                                                                                        class_id,
                                                                                        name, sign);
