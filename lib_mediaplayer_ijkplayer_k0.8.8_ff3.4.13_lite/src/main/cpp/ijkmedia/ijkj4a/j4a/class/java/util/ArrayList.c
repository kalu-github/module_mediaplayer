...
jobject J4AC_java_util_ArrayList__ArrayList(JNIEnv *env) {
    return (*env)->NewObject(env, class_J4AC_java_util_ArrayList.id,
                             class_J4AC_java_util_ArrayList.constructor_ArrayList);
}
...
int J4A_loadClass__J4AC_java_util_ArrayList(JNIEnv *env) {
    ...
    name = "<init>";
    sign = "()V";
    class_J4AC_java_util_ArrayList.constructor_ArrayList = J4A_GetMethodID__catchAll(env, class_id,
                                                                                     name, sign);
    ...
    class_J4AC_java_util_ArrayList.method_add = J4A_GetMethodID__catchAll(env, class_id, name,
                                                                          sign);
