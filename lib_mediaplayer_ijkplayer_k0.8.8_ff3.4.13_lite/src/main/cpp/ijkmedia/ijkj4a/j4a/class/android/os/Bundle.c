...
jobject J4AC_android_os_Bundle__Bundle(JNIEnv *env) {
    return (*env)->NewObject(env, class_J4AC_android_os_Bundle.id,
                             class_J4AC_android_os_Bundle.constructor_Bundle);
}
...
jint J4AC_android_os_Bundle__getInt(JNIEnv *env, jobject thiz, jstring key, jint defaultValue) {
    return (*env)->CallIntMethod(env, thiz, class_J4AC_android_os_Bundle.method_getInt, key,
                                 defaultValue);
}

jint J4AC_android_os_Bundle__getInt__catchAll(JNIEnv *env, jobject thiz, jstring key,
                                              jint defaultValue) {
...
jint J4AC_android_os_Bundle__getInt__withCString(JNIEnv *env, jobject thiz, const char *key_cstr__,
                                                 jint defaultValue) {
    jint ret_value = 0;
    jstring key = NULL;
...
jint J4AC_android_os_Bundle__getInt__withCString__catchAll(JNIEnv *env, jobject thiz,
                                                           const char *key_cstr__,
                                                           jint defaultValue) {
    jint ret_value = 0;
    jstring key = NULL;
...
void J4AC_android_os_Bundle__putInt__withCString(JNIEnv *env, jobject thiz, const char *key_cstr__,
                                                 jint value) {
    jstring key = NULL;
...
void J4AC_android_os_Bundle__putInt__withCString__catchAll(JNIEnv *env, jobject thiz,
                                                           const char *key_cstr__, jint value) {
    jstring key = NULL;
...
jstring
J4AC_android_os_Bundle__getString__asGlobalRef__catchAll(JNIEnv *env, jobject thiz, jstring key) {
...
const char *
J4AC_android_os_Bundle__getString__asCBuffer(JNIEnv *env, jobject thiz, jstring key, char *out_buf,
                                             int out_len) {
...
const char *
J4AC_android_os_Bundle__getString__asCBuffer__catchAll(JNIEnv *env, jobject thiz, jstring key,
...
jstring
J4AC_android_os_Bundle__getString__withCString(JNIEnv *env, jobject thiz, const char *key_cstr__) {
    jstring ret_object = NULL;
    jstring key = NULL;
...
jstring J4AC_android_os_Bundle__getString__withCString__catchAll(JNIEnv *env, jobject thiz,
                                                                 const char *key_cstr__) {
    jstring ret_object = NULL;
    jstring key = NULL;
...
jstring
J4AC_android_os_Bundle__getString__withCString__asGlobalRef__catchAll(JNIEnv *env, jobject thiz,
                                                                      const char *key_cstr__) {
    jstring ret_object = NULL;
    jstring local_object = J4AC_android_os_Bundle__getString__withCString__catchAll(env, thiz,
                                                                                    key_cstr__);
    if (J4A_ExceptionCheck__catchAll(env) || !local_object) {
        ret_object = NULL;
        goto fail;
...
const char *J4AC_android_os_Bundle__getString__withCString__asCBuffer(JNIEnv *env, jobject thiz,
                                                                      const char *key_cstr__,
                                                                      char *out_buf, int out_len) {
    const char *ret_value = NULL;
    const char *c_str = NULL;
...
const char *
J4AC_android_os_Bundle__getString__withCString__asCBuffer__catchAll(JNIEnv *env, jobject thiz,
                                                                    const char *key_cstr__,
                                                                    char *out_buf, int out_len) {
    const char *ret_value = NULL;
    const char *c_str = NULL;
    jstring local_string = J4AC_android_os_Bundle__getString__withCString__catchAll(env, thiz,
                                                                                    key_cstr__);
    if (J4A_ExceptionCheck__catchAll(env) || !local_string) {
        goto fail;
    }
...
void
J4AC_android_os_Bundle__putString__catchAll(JNIEnv *env, jobject thiz, jstring key, jstring value) {
    J4AC_android_os_Bundle__putString(env, thiz, key, value);
    J4A_ExceptionCheck__catchAll(env);
}

void
J4AC_android_os_Bundle__putString__withCString(JNIEnv *env, jobject thiz, const char *key_cstr__,
                                               const char *value_cstr__) {
    jstring key = NULL;
    jstring value = NULL;
...
void J4AC_android_os_Bundle__putString__withCString__catchAll(JNIEnv *env, jobject thiz,
                                                              const char *key_cstr__,
                                                              const char *value_cstr__) {
    jstring key = NULL;
    jstring value = NULL;
...
void J4AC_android_os_Bundle__putParcelableArrayList(JNIEnv *env, jobject thiz, jstring key,
                                                    jobject value) {
    (*env)->CallVoidMethod(env, thiz, class_J4AC_android_os_Bundle.method_putParcelableArrayList,
                           key, value);
}

void
J4AC_android_os_Bundle__putParcelableArrayList__catchAll(JNIEnv *env, jobject thiz, jstring key,
                                                         jobject value) {
    J4AC_android_os_Bundle__putParcelableArrayList(env, thiz, key, value);
    J4A_ExceptionCheck__catchAll(env);
}

void J4AC_android_os_Bundle__putParcelableArrayList__withCString(JNIEnv *env, jobject thiz,
                                                                 const char *key_cstr__,
                                                                 jobject value) {
    jstring key = NULL;
...
void
J4AC_android_os_Bundle__putParcelableArrayList__withCString__catchAll(JNIEnv *env, jobject thiz,
                                                                      const char *key_cstr__,
                                                                      jobject value) {
    jstring key = NULL;
...
jlong
J4AC_android_os_Bundle__getLong__withCString(JNIEnv *env, jobject thiz, const char *key_cstr__) {
    jlong ret_value = 0;
    jstring key = NULL;
...
jlong J4AC_android_os_Bundle__getLong__withCString__catchAll(JNIEnv *env, jobject thiz,
                                                             const char *key_cstr__) {
    jlong ret_value = 0;
    jstring key = NULL;
...
void
J4AC_android_os_Bundle__putLong__catchAll(JNIEnv *env, jobject thiz, jstring key, jlong value) {
    J4AC_android_os_Bundle__putLong(env, thiz, key, value);
    J4A_ExceptionCheck__catchAll(env);
}

void J4AC_android_os_Bundle__putLong__withCString(JNIEnv *env, jobject thiz, const char *key_cstr__,
                                                  jlong value) {
    jstring key = NULL;
...
void J4AC_android_os_Bundle__putLong__withCString__catchAll(JNIEnv *env, jobject thiz,
                                                            const char *key_cstr__, jlong value) {
    jstring key = NULL;
...
int J4A_loadClass__J4AC_android_os_Bundle(JNIEnv *env) {
    ...
    name = "<init>";
    sign = "()V";
    class_J4AC_android_os_Bundle.constructor_Bundle = J4A_GetMethodID__catchAll(env, class_id, name,
                                                                                sign);
    ...
    class_J4AC_android_os_Bundle.method_getInt = J4A_GetMethodID__catchAll(env, class_id, name,
                                                                           sign);
    ...
    class_J4AC_android_os_Bundle.method_putInt = J4A_GetMethodID__catchAll(env, class_id, name,
                                                                           sign);
    ...
    class_J4AC_android_os_Bundle.method_getString = J4A_GetMethodID__catchAll(env, class_id, name,
                                                                              sign);
    ...
    class_J4AC_android_os_Bundle.method_putString = J4A_GetMethodID__catchAll(env, class_id, name,
                                                                              sign);
    ...
    class_J4AC_android_os_Bundle.method_putParcelableArrayList = J4A_GetMethodID__catchAll(env,
                                                                                           class_id,
                                                                                           name,
                                                                                           sign);
    ...
    class_J4AC_android_os_Bundle.method_getLong = J4A_GetMethodID__catchAll(env, class_id, name,
                                                                            sign);
    ...
    class_J4AC_android_os_Bundle.method_putLong = J4A_GetMethodID__catchAll(env, class_id, name,
                                                                            sign);
