...
jobject J4AC_android_media_AudioTrack__AudioTrack(JNIEnv *env, jint streamType, jint sampleRateInHz,
    ...
    return (*env)->NewObject(env, class_J4AC_android_media_AudioTrack.id,
...
jobject J4AC_android_media_AudioTrack__AudioTrack__catchAll(JNIEnv *env, jint streamType,
                                                            ...
                                                            jint audioFormat,
                                                            jint bufferSizeInBytes, jint mode) {
    jobject ret_object = J4AC_android_media_AudioTrack__AudioTrack(env, streamType, sampleRateInHz,
...
J4AC_android_media_AudioTrack__AudioTrack__asGlobalRef__catchAll(JNIEnv *env, jint streamType,
    ...
    jobject local_object = J4AC_android_media_AudioTrack__AudioTrack__catchAll(env, streamType,
                                                                               sampleRateInHz,
                                                                               channelConfig,
                                                                               audioFormat,
                                                                               bufferSizeInBytes,
...
jint J4AC_android_media_AudioTrack__getMinBufferSize(JNIEnv *env, jint sampleRateInHz,
                                                     jint channelConfig, jint audioFormat) {
    return (*env)->CallStaticIntMethod(env, class_J4AC_android_media_AudioTrack.id,
...
jint J4AC_android_media_AudioTrack__getMinBufferSize__catchAll(JNIEnv *env, jint sampleRateInHz,
                                                               jint channelConfig,
                                                               jint audioFormat) {
    jint ret_value = J4AC_android_media_AudioTrack__getMinBufferSize(env, sampleRateInHz,
                                                                     channelConfig, audioFormat);
...
jfloat J4AC_android_media_AudioTrack__getMaxVolume(JNIEnv *env) {
    return (*env)->CallStaticFloatMethod(env, class_J4AC_android_media_AudioTrack.id,
...
jint J4AC_android_media_AudioTrack__write(JNIEnv *env, jobject thiz, jbyteArray audioData,
    ...
    return (*env)->CallIntMethod(env, thiz, class_J4AC_android_media_AudioTrack.method_write,
...
jint J4AC_android_media_AudioTrack__write__catchAll(JNIEnv *env, jobject thiz, jbyteArray audioData,
                                                    jint offsetInBytes, jint sizeInBytes) {
    jint ret_value = J4AC_android_media_AudioTrack__write(env, thiz, audioData, offsetInBytes,
                                                          sizeInBytes);
    if (J4A_ExceptionCheck__catchAll(env)) {
        return 0;
    }
...
void J4AC_android_media_AudioTrack__setPlaybackParams(JNIEnv *env, jobject thiz, jobject params) {
    (*env)->CallVoidMethod(env, thiz, class_J4AC_android_media_AudioTrack.method_setPlaybackParams,
                           params);
}
...
jint
J4AC_android_media_AudioTrack__setPlaybackRate(JNIEnv *env, jobject thiz, jint sampleRateInHz) {
    return (*env)->CallIntMethod(env, thiz,
...
int J4A_loadClass__J4AC_android_media_AudioTrack(JNIEnv *env) {
    ...
    name = "<init>";
    sign = "(IIIIII)V";
    class_J4AC_android_media_AudioTrack.constructor_AudioTrack = J4A_GetMethodID__catchAll(env,
                                                                                           class_id,
                                                                                           name,
                                                                                           sign);
    ...
    sign = "(III)I";
    class_J4AC_android_media_AudioTrack.method_getMinBufferSize = J4A_GetStaticMethodID__catchAll(
    ...
    name = "getMaxVolume";
    sign = "()F";
    class_J4AC_android_media_AudioTrack.method_getMaxVolume = J4A_GetStaticMethodID__catchAll(env,
                                                                                              class_id,
                                                                                              name,
                                                                                              sign);
    ...
    name = "getMinVolume";
    sign = "()F";
    class_J4AC_android_media_AudioTrack.method_getMinVolume = J4A_GetStaticMethodID__catchAll(env,
                                                                                              class_id,
                                                                                              name,
                                                                                              sign);
    ...
    sign = "(I)I";
    class_J4AC_android_media_AudioTrack.method_getNativeOutputSampleRate = J4A_GetStaticMethodID__catchAll(
            env, class_id, name, sign);
    ...
    name = "play";
    sign = "()V";
    class_J4AC_android_media_AudioTrack.method_play = J4A_GetMethodID__catchAll(env, class_id, name,
                                                                                sign);
    ...
    name = "pause";
    sign = "()V";
    class_J4AC_android_media_AudioTrack.method_pause = J4A_GetMethodID__catchAll(env, class_id,
                                                                                 name, sign);
    ...
    name = "stop";
    sign = "()V";
    class_J4AC_android_media_AudioTrack.method_stop = J4A_GetMethodID__catchAll(env, class_id, name,
                                                                                sign);
    ...
    name = "flush";
    sign = "()V";
    class_J4AC_android_media_AudioTrack.method_flush = J4A_GetMethodID__catchAll(env, class_id,
                                                                                 name, sign);
    ...
    name = "release";
    sign = "()V";
    class_J4AC_android_media_AudioTrack.method_release = J4A_GetMethodID__catchAll(env, class_id,
                                                                                   name, sign);
    ...
    name = "write";
    sign = "([BII)I";
    class_J4AC_android_media_AudioTrack.method_write = J4A_GetMethodID__catchAll(env, class_id,
                                                                                 name, sign);
    ...
    sign = "(FF)I";
    class_J4AC_android_media_AudioTrack.method_setStereoVolume = J4A_GetMethodID__catchAll(env,
                                                                                           class_id,
                                                                                           name,
                                                                                           sign);
    ...
    sign = "()I";
    class_J4AC_android_media_AudioTrack.method_getAudioSessionId = J4A_GetMethodID__catchAll(env,
                                                                                             class_id,
                                                                                             name,
                                                                                             sign);
    ...
    if (J4A_GetSystemAndroidApiLevel(env) >= 23) {
        ...
        class_J4AC_android_media_AudioTrack.method_getPlaybackParams = J4A_GetMethodID__catchAll(
                env, class_id, name, sign);
    ...
    if (J4A_GetSystemAndroidApiLevel(env) >= 23) {
        ...
        class_J4AC_android_media_AudioTrack.method_setPlaybackParams = J4A_GetMethodID__catchAll(
                env, class_id, name, sign);
    ...
    name = "getStreamType";
    sign = "()I";
    class_J4AC_android_media_AudioTrack.method_getStreamType = J4A_GetMethodID__catchAll(env,
                                                                                         class_id,
                                                                                         name,
                                                                                         sign);
    ...
    name = "getSampleRate";
    sign = "()I";
    class_J4AC_android_media_AudioTrack.method_getSampleRate = J4A_GetMethodID__catchAll(env,
                                                                                         class_id,
                                                                                         name,
                                                                                         sign);
    ...
    sign = "()I";
    class_J4AC_android_media_AudioTrack.method_getPlaybackRate = J4A_GetMethodID__catchAll(env,
                                                                                           class_id,
                                                                                           name,
                                                                                           sign);
    ...
    sign = "(I)I";
    class_J4AC_android_media_AudioTrack.method_setPlaybackRate = J4A_GetMethodID__catchAll(env,
                                                                                           class_id,
                                                                                           name,
                                                                                           sign);
