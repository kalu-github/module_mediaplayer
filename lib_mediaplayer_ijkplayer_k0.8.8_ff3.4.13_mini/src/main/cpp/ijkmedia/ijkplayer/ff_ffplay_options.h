...
static const AVOption ffp_context_options[] = {
        ...
        {"min-frames", "minimal frames to stop pre-reading",
         OPTION_OFFSET(dcc.min_frames), OPTION_INT(DEFAULT_MIN_FRAMES, MIN_MIN_FRAMES,
                                                   MAX_MIN_FRAMES)},
        ...
        {"no-time-adjust",
         "return player's real time from the media stream instead of the adjusted time",
        ...
        {"accurate-seek-timeout", "accurate seek timeout",
         OPTION_OFFSET(accurate_seek_timeout), OPTION_INT(MAX_ACCURATE_SEEK_TIMEOUT, 0,
                                                          MAX_ACCURATE_SEEK_TIMEOUT)},
        ...
        {"videotoolbox-wait-async",
         "VideoToolbox: call VTDecompressionSessionWaitForAsynchronousFrames()",
         OPTION_OFFSET(vtb_wait_async), OPTION_INT(1, 0, 1)},
        {"videotoolbox-handle-resolution-change",
         "VideoToolbox: handle resolution change automatically",
        ...
        {"mediacodec-all-videos",
         "MediaCodec: enable all videos(0:ffmpeg_soft,1:ijk_mediacodec,2:ffmpeg_mediacodec)",
         OPTION_OFFSET(mediacodec_all_videos), OPTION_INT(0, 0, 2)},
        {"mediacodec-avc",
         "MediaCodec: enable H264(0:ffmpeg_soft,1:ijk_mediacodec,2:ffmpeg_mediacodec)",
         OPTION_OFFSET(mediacodec_avc), OPTION_INT(0, 0, 2)},
        {"mediacodec-hevc",
         "MediaCodec: enable HEVC(0:ffmpeg_soft,1:ijk_mediacodec,2:ffmpeg_mediacodec)",
         OPTION_OFFSET(mediacodec_hevc), OPTION_INT(0, 0, 2)},
        {"mediacodec-mpeg2",
         "MediaCodec: enable MPEG2VIDEO(0:ffmpeg_soft,1:ijk_mediacodec,2:ffmpeg_mediacodec)",
         OPTION_OFFSET(mediacodec_mpeg2), OPTION_INT(0, 0, 2)},
        {"mediacodec-mpeg4",
         "MediaCodec: enable MPEG4(0:ffmpeg_soft,1:ijk_mediacodec,2:ffmpeg_mediacodec)",
         OPTION_OFFSET(mediacodec_mpeg4), OPTION_INT(0, 0, 2)},
        {"mediacodec-vp8",
         "MediaCodec: enable VP8(0:ffmpeg_soft,1:ijk_mediacodec,2:ffmpeg_mediacodec)",
         OPTION_OFFSET(mediacodec_vp8), OPTION_INT(0, 0, 2)},
        {"mediacodec-vp9",
         "MediaCodec: enable VP9(0:ffmpeg_soft,1:ijk_mediacodec,2:ffmpeg_mediacodec)",
         OPTION_OFFSET(mediacodec_vp9), OPTION_INT(0, 0, 2)},
