...
# listener
-keep class lib.kalu.mediaplayer.listener.OnPlayerAudioChangeListener {
    public <fields>;
    public <methods>;
}
-keep class lib.kalu.mediaplayer.listener.OnPlayerChangeListener {
    public <fields>;
    public <methods>;
}
...
-keep class lib.kalu.mediaplayer.config.player.** {
    public <fields>;
    public <methods>;
}
