...
public final class AudioExoPlayerFactory implements AudioKernelFactory<AudioExoPlayer> {
    ...
    @Override
    public AudioExoPlayer createKernel(@NonNull AudioPlayerApi playerApi, @NonNull AudioKernelApiEvent event, @NonNull boolean retryBuffering) {
        return new AudioExoPlayer(playerApi, event, retryBuffering);
    }
}
