...
@Keep
public final class AudioExoPlayer2 extends AudioBasePlayer {
    ...
    public AudioExoPlayer2(@NonNull AudioPlayerApi playerApi, @NonNull AudioKernelApiEvent eventApi, @NonNull boolean retryBuffering) {
    ...
    public void releaseDecoder(boolean isFromUser, boolean isMainThread) {
        try {
            ...
            MPLogUtil.log("AudioExoPlayer2 => releaseDecoder => " + e.getMessage());
        }
    }
    ...
    public void initExoFFmpeg(@NonNull Context context, @NonNull ExoPlayer.Builder exoBuilder) {
        try {
            ...
            // only_ffmpeg | only_ffmpeg_audio
            if (exoFFmpeg == PlayerType.FFmpegType.EXO_RENDERER_ONLY_FFMPEG || exoFFmpeg == PlayerType.FFmpegType.EXO_RENDERER_ONLY_FFMPEG_AUDIO) {
            ...
            MPLogUtil.log("AudioExoPlayer2 => initExoFFmpeg => " + e.getMessage());
        }
    }
...
//        MPLogUtil.log("AudioExoPlayer2 => onPlayWhenReadyChanged => playWhenReady = " + playWhenReady + ", reason = " + reason);
                }

                @Override
                public void onPlayerError(EventTime eventTime, PlaybackException error) {
                    MPLogUtil.log("AudioExoPlayer2 => onPlayerError => error = " + error.getMessage() + ", mExoPlayer = " + mExoPlayer + ", mRetryBuffering = " + mRetryBuffering);
                ...
                public void onTimelineChanged(EventTime eventTime, int reason) {
                    MPLogUtil.log("AudioExoPlayer2 => onTimelineChanged => reason = " + reason + ", totalBufferedDurationMs = " + eventTime.totalBufferedDurationMs + ", realtimeMs = " + eventTime.realtimeMs);
                }

                @Override
                public void onEvents(Player player, Events events) {
//                    MediaLogUtil.log("AudioExoPlayer2 => onEvents => isPlaying = " + player.isPlaying());
                }
                ...
                public void onIsPlayingChanged(EventTime eventTime, boolean isPlaying) {
                    MPLogUtil.log("AudioExoPlayer2 => onIsPlayingChanged => isPlaying = " + isPlaying + ", mPlayWhenReady = " + mPlayWhenReady + ", mPrepared = " + mPrepared);
                }

                @Override
                public void onPlaybackStateChanged(EventTime eventTime, int state) {
                    MPLogUtil.log("AudioExoPlayer2 => onPlaybackStateChanged => state = " + state + ", mute = " + isMute());
                    ...
                    // 播放开始
                        ...
                        MPLogUtil.log("AudioExoPlayer2 => onPlaybackStateChanged[播放开始] => mPrepared = " + mPrepared + ", mRetryBuffering = " + mRetryBuffering);
                        try {
                            if (mPrepared)
...
//                                }
                    ...
                    // 播放缓冲
                        ...
                        MPLogUtil.log("AudioExoPlayer2 => onPlaybackStateChanged[播放缓冲] =>");
                        try {
                            if (!mPrepared)
                    ...
                    // 未知??
                        ...
                        MPLogUtil.log("AudioExoPlayer2 => onPlaybackStateChanged[未知??] =>");
                    }
                }

                @Override
                public void onRenderedFirstFrame(EventTime eventTime, Object output, long renderTimeMs) {
                    MPLogUtil.log("AudioExoPlayer2 => onRenderedFirstFrame =>");
                    try {
                        long seek = getSeek();
                        if (seek <= 0)
                        ...
                        MPLogUtil.log("AudioExoPlayer2 => onRenderedFirstFrame => " + e.getMessage());
                    }
                }

                @Override
                public void onVideoInputFormatChanged(EventTime eventTime, Format format, @Nullable DecoderReuseEvaluation decoderReuseEvaluation) {
                    MPLogUtil.log("AudioExoPlayer2 => onVideoInputFormatChanged[出画面] =>");
                }
                ...
                public void onAudioInputFormatChanged(EventTime eventTime, Format format, @Nullable DecoderReuseEvaluation decoderReuseEvaluation) {
                    MPLogUtil.log("AudioExoPlayer2 => onAudioInputFormatChanged =>");
                }
            };
...
//        }
            ...
            MPLogUtil.log("AudioExoPlayer2 => createDecoder => " + e.getMessage());
        }
    }

    @Override
    public void startDecoder(@NonNull Context context, @NonNull String url, @NonNull boolean prepareAsync) {
        MPLogUtil.log("AudioExoPlayer2 => startDecoder => mExoPlayer = " + mExoPlayer + ", url = " + url + ", prepareAsync = " + prepareAsync);
        try {
            if (null == mExoPlayer)
                throw new Exception("mExoPlayer error: null");
...
//            });
    ...
    public boolean isPlaying() {
        try {
            ...
            MPLogUtil.log("AudioExoPlayer2 => isPlaying => " + e.getMessage());
            return false;
        }
    }
    ...
    public void seekTo(@NonNull long position) {
        try {
            ...
            MPLogUtil.log("AudioExoPlayer2 => seekTo => " + e.getMessage());
        }
    }
    ...
    public long getPosition() {
        try {
            ...
            MPLogUtil.log("AudioExoPlayer2 => getPosition => " + e.getMessage());
            return -1L;
        }
    }
    ...
    public long getDuration() {
        try {
            ...
            MPLogUtil.log("AudioExoPlayer2 => getDuration => " + e.getMessage());
            return -1L;
        }
    }
    ...
    public void setVolume(float v1, float v2) {
        try {
            float value;
            boolean mute = isMute();
            MPLogUtil.log("AudioExoPlayer2 => setVolume => mute = " + mute);
            if (mute) {
                value = 0F;
            } else {
            ...
            MPLogUtil.log("AudioExoPlayer2 => setVolume => value = " + value);
            mExoPlayer.setVolume(value);
        } catch (Exception e) {
            MPLogUtil.log("AudioExoPlayer2 => setVolume => " + e.getMessage());
        }
    }
    ...
    public void release(boolean isMainThread) {
        try {
            ...
            MPLogUtil.log("AudioExoPlayer2 => release => " + e.getMessage());
        }
    }
    ...
    public void start() {
        try {
            ...
            MPLogUtil.log("AudioExoPlayer2 => start => " + e.getMessage());
        }
    }
    ...
    public void pause() {
        try {
            ...
            MPLogUtil.log("AudioExoPlayer2 => pause => " + e.getMessage());
        }
    }
    ...
    public void stop(boolean isMainThread) {
        try {
            ...
            MPLogUtil.log("AudioExoPlayer2 => stop => " + e.getMessage());
        }
    }
...
//            refreshHeaders(httpFactory, headers);
            ...
            MPLogUtil.log("AudioExoPlayer2 => createMediaSource => useOkhttp = " + useOkhttp);
            DataSource.Factory dataSourceFactory;
            if (useOkhttp) {
                int okhttpTimeoutSeconds = PlayerManager.getInstance().getConfig().getExoUseOkhttpTimeoutSeconds();
                MPLogUtil.log("AudioExoPlayer2 => createMediaSource => okhttpTimeoutSeconds = " + okhttpTimeoutSeconds);
