 ...
 */
@UnstableApi
public final class VideoMediaxPlayerSimpleCacheDataSource implements DataSource {

    /**
     * {@link DataSource.Factory} for {@link VideoMediaxPlayerSimpleCacheDataSource} instances.
     */
    public static final class Factory implements DataSource.Factory {
         ...
         * be thrown instead.
         *
         * <p>Note that requests to {@link VideoMediaxPlayerSimpleCacheDataSource} instances are intended to be used as parts
         * of (possibly larger) tasks that are registered with the {@link PriorityTaskManager}, and
         * hence {@link VideoMediaxPlayerSimpleCacheDataSource} does <em>not</em> register a task by itself. This must be done
         * by the surrounding code that uses the {@link VideoMediaxPlayerSimpleCacheDataSource} instances.
         *
        ...
        @Override
        public VideoMediaxPlayerSimpleCacheDataSource createDataSource() {
         ...
         */
        public VideoMediaxPlayerSimpleCacheDataSource createDataSourceForDownloading() {
            return createDataSourceInternal(
                    upstreamDataSourceFactory != null ? upstreamDataSourceFactory.createDataSource() : null,
         ...
         */
        public VideoMediaxPlayerSimpleCacheDataSource createDataSourceForRemovingDownload() {
            return createDataSourceInternal(
                    /* upstreamDataSource= */ null, flags | FLAG_BLOCK_ON_CACHE, C.PRIORITY_DOWNLOAD);
        }

        private VideoMediaxPlayerSimpleCacheDataSource createDataSourceInternal(
            ...
            return new VideoMediaxPlayerSimpleCacheDataSource(
                    cache,
                    upstreamDataSource,
    ...
    /**
     * Listener of {@link VideoMediaxPlayerSimpleCacheDataSource} events.
     */
     ...
     */
    public VideoMediaxPlayerSimpleCacheDataSource(Cache cache, @Nullable DataSource upstreamDataSource) {
     ...
     */
    public VideoMediaxPlayerSimpleCacheDataSource(Cache cache, @Nullable DataSource upstreamDataSource, @Flags int flags) {
        this(
                cache,
                upstreamDataSource,
                new FileDataSource(),
     ...
     */
    public VideoMediaxPlayerSimpleCacheDataSource(
            Cache cache,
    ...
    private VideoMediaxPlayerSimpleCacheDataSource(
            Cache cache,
            @Nullable DataSource upstreamDataSource,
            DataSource cacheReadDataSource,
            @Nullable DataSink cacheWriteDataSink,
