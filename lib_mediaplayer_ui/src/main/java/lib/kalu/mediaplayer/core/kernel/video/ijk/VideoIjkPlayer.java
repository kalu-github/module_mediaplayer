...
//                    onEvent(kernelType, what);
    ...
    public void startPlayWhenReadyDelayedTime(long delayedTime) {
        try {
            ...
            if (null == mHandlerPlayWhenReadyDelayedTime) {
                mHandlerPlayWhenReadyDelayedTime = new android.os.Handler(Looper.getMainLooper()) {
                    ...
                    public void handleMessage(@NonNull Message msg) {
                        try {
                            // 起播快进
                            onEvent(PlayerType.KernelType.IJK, PlayerType.EventType.RESUME);
                            start();
                        } catch (Exception e) {
                            LogUtil.log("VideoIjkPlayer => startPlayWhenReadyDelayedTime => Exception2 " + e.getMessage());
                        } finally {
            ...
            LogUtil.log("VideoIjkPlayer => startPlayWhenReadyDelayedTime => Exception1 " + e.getMessage());
        }
    }
    ...
    public void stopPlayWhenReadyDelayedTime() {
        try {
            ...
            LogUtil.log("VideoIjkPlayer => playWhenReadyDelayedTime => stop mHandlerPlayWhenReadyDelayedTime");
        } catch (Exception e) {
            LogUtil.log("VideoIjkPlayer => playWhenReadyDelayedTime => " + e.getMessage());
        }
    }
    ...
    public void startCheckPreparedPlaying() {
        try {
                    ...
                    public void handleMessage(@NonNull Message msg) {
                        try {
                            ...
                            // 轮询
                                ...
                                LogUtil.log("VideoIjkPlayer => startCheckPreparedPlaying => loop next");
                                mHandlerPreparedPlaying.sendEmptyMessageDelayed(10001, 1000);
                            }
                        } catch (Exception e) {
                            LogUtil.log("VideoIjkPlayer => startCheckPreparedPlaying => Exception2 " + e.getMessage());
                            stopCheckPreparedPlaying();
                        }
                    }
                };
            ...
            LogUtil.log("VideoIjkPlayer => startCheckPreparedPlaying => Exception1 " + e.getMessage());
            stopCheckPreparedPlaying();
        }
    }
    ...
    public void stopCheckPreparedPlaying() {
        try {
            ...
            LogUtil.log("VideoIjkPlayer => stopCheckPreparedPlaying => stop mHandlerPreparedPlaying");
        } catch (Exception e) {
            LogUtil.log("VideoIjkPlayer => stopCheckPreparedPlaying => " + e.getMessage());
        }
    }
    ...
    public void startCheckConnectTimeout(long timeout) {
        try {
                    ...
                    public void handleMessage(@NonNull Message msg) {
                        try {
                            ...
                            // 轮询
                                ...
                                LogUtil.log("VideoIjkPlayer => startCheckConnectTimeout => loop next, cast = " + cast);
                            ...
                            LogUtil.log("VideoIjkPlayer => startCheckConnectTimeout => Exception2 " + e.getMessage());
            ...
            LogUtil.log("VideoIjkPlayer => startCheckConnectTimeout => Exception1 " + e.getMessage());
            stopCheckConnectTimeout();
        }
    }
    ...
    public void stopCheckConnectTimeout() {
        try {
            ...
            LogUtil.log("VideoIjkPlayer => stopCheckConnectTimeout => stop mHandlerConnectTimeout");
        } catch (Exception e) {
            LogUtil.log("VideoIjkPlayer => stopCheckConnectTimeout => " + e.getMessage());
        }
    }
                ...
                mHandlerBufferingTimeout = new android.os.Handler(Looper.getMainLooper()) {
                    ...
                    public void handleMessage(@NonNull Message msg) {
                        ...
                        try {
                            ...
                            // 超时
                            if (cast >= timeout) {
                                onEvent(PlayerType.KernelType.IJK, PlayerType.EventType.ERROR_BUFFERING_TIMEOUT);
                                // 1
...
//                              // 2
                            ...
                            // 轮询
                                ...
                                LogUtil.log("VideoIjkPlayer => startCheckBufferingTimeout => loop next, cast = " + cast);
                                Message message = Message.obtain();
                                message.what = 10003;
                                message.obj = start;
                            ...
                            LogUtil.log("VideoIjkPlayer => startCheckBufferingTimeout => " + e.getMessage());
                            stopCheckBufferingTimeout();
                        }
                    }
                };
    ...
    public void stopCheckBufferingTimeout() {
        try {
            ...
            LogUtil.log("VideoIjkPlayer => stopCheckBufferingTimeout => stop mHandlerBufferingTimeout");
        } catch (Exception e) {
            LogUtil.log("VideoIjkPlayer => stopCheckBufferingTimeout => " + e.getMessage());
        }
    }
}
