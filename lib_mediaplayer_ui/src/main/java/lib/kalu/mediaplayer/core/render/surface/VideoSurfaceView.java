...
//            getHolder().setFixedSize(measureSpec[0], measureSpec[1]);
    ...
    public void startUpdateProgress() {
        try {
                ...
                mHandlerUpdateProgress = new Handler(Looper.getMainLooper()) {
                    ...
                    public void handleMessage(Message msg) {
                        try {
                            ...
                            LogUtil.log("VideoSurfaceView => startUpdateProgress => handleMessage => Exception" + e.getMessage());
                        }
                    }
                };
            }
            ...
            mHandlerUpdateProgress.sendEmptyMessageDelayed(10100, 1000);
            LogUtil.log("VideoSurfaceView => startUpdateProgress =>");
        } catch (Exception e) {
            LogUtil.log("VideoSurfaceView => startUpdateProgress => Exception " + e.getMessage());
            stopUpdateProgress();
        }
    }
    ...
    public void stopUpdateProgress() {
        try {
            ...
            LogUtil.log("VideoSurfaceView => stopUpdateProgress =>");
        } catch (Exception e) {
            LogUtil.log("VideoSurfaceView => stopUpdateProgress => Exception" + e.getMessage());
        }
    }
}
