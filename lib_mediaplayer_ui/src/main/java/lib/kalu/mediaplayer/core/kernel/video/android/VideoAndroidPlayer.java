...
public final class VideoAndroidPlayer extends VideoBasePlayer {
    ...
    public VideoAndroidPlayer(@NonNull VideoPlayerApi playerApi, @NonNull VideoKernelApiEvent eventApi, @NonNull boolean retryBuffering) {
...
//                }
            ...
            // 开始播放2
                ...
                onEvent(PlayerType.VideoKernelType.VIDEO_ANDROID, PlayerType.EventType.EVENT_VIDEO_START_903);
            }
            return true;
        }
    };
    ...
    private MediaPlayer.OnVideoSizeChangedListener onVideoSizeChangedListener = new MediaPlayer.OnVideoSizeChangedListener() {
        ...
        public void onVideoSizeChanged(MediaPlayer mp, int width, int height) {
            try {
                ...
                onMeasure(PlayerType.VideoKernelType.VIDEO_ANDROID, videoWidth, videoHeight, PlayerType.RotationType.Rotation_0);
            } catch (Exception e) {
