...
//        LogUtil.log("PlayerView => dispatchKeyEvent => action = " + event.getAction() + ", code = " + event.getKeyCode() + ", isFull = " + isFull());
    ...
    /**************/
    private OnPlayerWindowListener mOnPlayerWindowListener = null;
    ...
    private OnPlayerEpisodeListener mOnPlayerEpisodeLiatener = null;

    @Override
    public void setOnPlayerEpisodeListener(OnPlayerEpisodeListener l) {
        this.mOnPlayerEpisodeLiatener = l;
    }

    @Override
    public OnPlayerEpisodeListener getOnPlayerEpisodeListener() {
        return this.mOnPlayerEpisodeLiatener;
    }
}