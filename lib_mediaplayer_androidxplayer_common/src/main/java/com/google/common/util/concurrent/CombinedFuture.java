...
final class CombinedFuture<V> extends AggregateFuture<Object, V> {
  ...
  CombinedFuture(
      ImmutableCollection<? extends ListenableFuture2<?>> futures,
  ...
  private final class AsyncCallableInterruptibleTask
      extends CombinedFutureInterruptibleTask<ListenableFuture2<V>> {
    ...
    ListenableFuture2<V> runInterruptibly() throws Exception {
      ListenableFuture2<V> result = callable.call();
      return checkNotNull(
          result,
    ...
    @Override
    void setValue(ListenableFuture2<V> value) {
