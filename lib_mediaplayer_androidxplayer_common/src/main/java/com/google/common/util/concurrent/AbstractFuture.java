...
/**
 * An abstract implementation of {@link ListenableFuture2}, intended for advanced users only. More
 ...
 * existing one, typically using methods like {@link Futures#transform(ListenableFuture2,
 * com.google.common.base.Function, Executor) Futures.transform} and {@link
 * Futures#catching(ListenableFuture2, Class, com.google.common.base.Function,
 ...
 * #setFuture(ListenableFuture2)} and {@link #setException(Throwable)}. Subclasses may also override
...
public abstract class AbstractFuture<V> extends InternalFutureFailureAccess
    implements ListenableFuture2<V> {
   ...
   */
  interface Trusted<V> extends ListenableFuture2<V> {}
  ...
  private static final class SetFuture<V> implements Runnable {
    ...
    final ListenableFuture2<? extends V> future;

    SetFuture(AbstractFuture<V> owner, ListenableFuture2<? extends V> future) {
      this.owner = owner;
      this.future = future;
    }
      ...
      while (true) {
        if (ATOMIC_HELPER.casValue(abstractFuture, localValue, valueToSet)) {
          ...
          if (localValue instanceof SetFuture) {
            ...
            ListenableFuture2<?> futureToPropagateTo = ((SetFuture) localValue).future;
   ...
   */
  @CanIgnoreReturnValue
  protected boolean setFuture(ListenableFuture2<? extends V> future) {
    checkNotNull(future);
    Object localValue = value;
    if (localValue == null) {
      if (future.isDone()) {
   ...
   */
  private static Object getFutureValue(ListenableFuture2<?> future) {
