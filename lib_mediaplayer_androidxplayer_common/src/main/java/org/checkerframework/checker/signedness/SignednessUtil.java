...
public final class SignednessUtil {
     ...
     * ByteBuffer#wrap(byte[]) wrap(byte[])}, but assumes that the input should be
    ...
    /**
     * Wraps an unsigned byte array into a ByteBuffer. This method is a wrapper around {@link
     * ByteBuffer#wrap(byte[], int, int) wrap(byte[], int, int)}, but assumes that the
     ...
     * ByteBuffer#getInt() getInt()}, but assumes that the result should be interpreted as
     * unsigned.
     */
    @SuppressWarnings("signedness")
     ...
     * ByteBuffer#getShort() getShort()}, but assumes that the result should be interpreted
     * as unsigned.
     */
    @SuppressWarnings("signedness")
     ...
     * ByteBuffer#get() get()}, but assumes that the result should be interpreted as
     * unsigned.
     */
    @SuppressWarnings("signedness")
     ...
     * ByteBuffer#get(int) get(int)}, but assumes that the result should be interpreted as
     * unsigned.
     */
    @SuppressWarnings("signedness")
     ...
     * wrapper around {@link ByteBuffer#get(byte[] bs, int, int) get(byte[], int, int)},
     ...
     * ByteBuffer#put(byte) put(byte)}, but assumes that the input should be interpreted as
     * unsigned.
     */
    @SuppressWarnings("signedness")
     ...
     * ByteBuffer#put(int, byte) put(int, byte)}, but assumes that the input should be
     * interpreted as unsigned.
     */
    @SuppressWarnings("signedness")
     ...
     * IntBuffer#put(int) put(int)}, but assumes that the input should be interpreted as
     * unsigned.
     */
    @SuppressWarnings("signedness")
     ...
     * IntBuffer#put(int, int) put(int, int)}, but assumes that the input should be
     * interpreted as unsigned.
     */
    @SuppressWarnings("signedness")
     ...
     * IntBuffer#put(int[]) put(int[])}, but assumes that the input should be interpreted
     * as unsigned.
     */
    @SuppressWarnings("signedness")
     ...
     * wrapper around {@link IntBuffer#put(int[], int, int) put(int[], int, int)}, but
     ...
     * IntBuffer#get(int) get(int)}, but assumes that the output should be interpreted as
     * unsigned.
     */
    @SuppressWarnings("signedness")
     ...
     * ByteBuffer#putShort(short) putShort(short)}, but assumes that the input should be
     * interpreted as unsigned.
     */
    @SuppressWarnings("signedness")
     ...
     * ByteBuffer#putShort(int, short) putShort(int, short)}, but assumes that the input
     ...
     * ByteBuffer#putInt(int) putInt(int)}, but assumes that the input should be
     * interpreted as unsigned.
     */
    @SuppressWarnings("signedness")
     ...
     * ByteBuffer#putInt(int, int) putInt(int, int)}, but assumes that the input should be
     * interpreted as unsigned.
     */
    @SuppressWarnings("signedness")
     ...
     * ByteBuffer#putLong(int, long) putLong(int, long)}, but assumes that the input should
     ...
     * RandomAccessFile#readByte() readByte()}, but assumes the output should be interpreted
     * as unsigned.
     */
    @SuppressWarnings("signedness")
     ...
     * RandomAccessFile#readChar() readChar()}, but assumes the output should be interpreted
     * as unsigned.
     */
    @SuppressWarnings("signedness")
     ...
     * RandomAccessFile#readShort() readShort()}, but assumes the output should be
     * interpreted as unsigned.
     */
    @SuppressWarnings("signedness")
     ...
     * RandomAccessFile#readInt() readInt()}, but assumes the output should be interpreted
     * as unsigned.
     */
    @SuppressWarnings("signedness")
     ...
     * RandomAccessFile#readLong() readLong()}, but assumes the output should be interpreted
     * as unsigned.
     */
    @SuppressWarnings("signedness")
     ...
     * method is a wrapper around {@link RandomAccessFile#read(byte[], int, int)
     ...
     * RandomAccessFile#readFully(byte[]) readFully(byte[])}, but assumes the output should
     * be interpreted as unsigned.
     */
    @SuppressWarnings("signedness")
     ...
     * around {@link RandomAccessFile#write(byte[], int, int) write(byte[], int, int)}, but
     ...
     * RandomAccessFile#writeByte(int) writeByte(int)}, but assumes the input should be
     * interpreted as unsigned.
     */
    @SuppressWarnings("signedness")
     ...
     * RandomAccessFile#writeChar(int) writeChar(int)}, but assumes the input should be
     * interpreted as unsigned.
     */
    @SuppressWarnings("signedness")
     ...
     * RandomAccessFile#writeShort(int) writeShort(int)}, but assumes the input should be
     * interpreted as unsigned.
     */
    @SuppressWarnings("signedness")
    ...
    /**
     * Writes an unsigned byte to the RandomAccessFile f. This method is a wrapper around {@link
     * RandomAccessFile#writeInt(int) writeInt(int)}, but assumes the input should be
     * interpreted as unsigned.
     */
    @SuppressWarnings("signedness")
    ...
    /**
     * Writes an unsigned byte to the RandomAccessFile f. This method is a wrapper around {@link
     * RandomAccessFile#writeLong(long) writeLong(long)}, but assumes the input should be
     * interpreted as unsigned.
     */
    @SuppressWarnings("signedness")
     ...
     * method is a wrapper around {@link ByteBuffer#get(byte[]) get(byte[])}, but assumes
