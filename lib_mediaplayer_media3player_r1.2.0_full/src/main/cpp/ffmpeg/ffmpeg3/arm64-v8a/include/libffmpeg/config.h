...
#define FFMPEG_CONFIGURATION "--arch=aarch64 --enable-yasm --disable-gpl --disable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-everything --disable-avdevice --disable-avformat --disable-swscale --disable-postproc --disable-avfilter --disable-symver --disable-avresample --enable-swresample --enable-avutil --enable-avcodec --disable-encoders --disable-encoder=png --disable-decoders --enable-decoder=ape --enable-decoder=aac --enable-decoder=vorbis --enable-decoder=opus --enable-decoder=flac --enable-decoder=alac --enable-decoder=pcm_mulaw --enable-decoder=pcm_alaw --enable-decoder=mp3 --enable-decoder=amrnb --enable-decoder=amrwb --enable-decoder=mlp --enable-decoder=truehd --disable-muxers --disable-demuxers --disable-parsers --disable-parser=mlp --disable-protocols --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vda --disable-vdpau --disable-hwaccels --disable-devices --disable-filters --disable-iconv --disable-audiotoolbox --disable-videotoolbox --disable-linux-perf --disable-bzlib --prefix=/home/kalu/download/ijkplayer-k0.8.8-ff3.4.12-audio/android/contrib/build/ffmpeg-arm64/output --cross-prefix=aarch64-linux-android- --enable-cross-compile --target-os=linux --enable-pic --enable-asm --enable-inline-asm --enable-optimizations --enable-debug --enable-small --extra-cflags='-O3 -Wall -pipe -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG ' --extra-ldflags=' '"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2022
#define FFMPEG_DATADIR "/home/kalu/download/ijkplayer-k0.8.8-ff3.4.12-audio/android/contrib/build/ffmpeg-arm64/output/share/ffmpeg"
#define AVCONV_DATADIR "/home/kalu/download/ijkplayer-k0.8.8-ff3.4.12-audio/android/contrib/build/ffmpeg-arm64/output/share/ffmpeg"
