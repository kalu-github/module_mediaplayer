...
Java_lib_kalu_exoplayer2_rtmp_RtmpClient_nativeOpen(JNIEnv* env, jobject thiz,
 ...
 */
JNIEXPORT jint JNICALL
Java_lib_kalu_exoplayer2_rtmp_RtmpClient_nativeRead(JNIEnv* env, jobject thiz,
...
JNIEXPORT void JNICALL
Java_lib_kalu_exoplayer2_rtmp_RTMPMuxer_write_1flv_1header(JNIEnv* env, jobject thiz,
                                                               jboolean is_have_audio, jboolean is_have_video) {
    write_flv_header(is_have_audio, is_have_video);
}

JNIEXPORT void JNICALL
Java_lib_kalu_exoplayer2_rtmp_RTMPMuxer_file_1open(JNIEnv* env, jobject thiz, jstring filename) {
...
JNIEXPORT void JNICALL
Java_lib_kalu_exoplayer2_rtmp_RTMPMuxer_file_1close(JNIEnv* env, jobject thiz) {
...
JNIEXPORT jint JNICALL
Java_lib_kalu_exoplayer2_rtmp_RTMPMuxer_read(JNIEnv* env, jobject thiz, jbyteArray data,
                                                 jint offset, jint size);

JNIEXPORT jboolean JNICALL
Java_lib_kalu_exoplayer2_rtmp_RTMPMuxer_isConnected(JNIEnv* env, jobject thiz);
