...
abstract class AggregateFuture<InputT, OutputT> extends AggregateFutureState<OutputT> {
   ...
   */
  @NullableDecl private ImmutableCollection<? extends ListenableFuture2<? extends InputT>> futures;

  private final boolean allMustSucceed;
  private final boolean collectsValues;

  AggregateFuture(
      ImmutableCollection<? extends ListenableFuture2<? extends InputT>> futures,
  ...
  final void init() {
    ...
    if (allMustSucceed) {
      ...
      int i = 0;
      for (final ListenableFuture2<? extends InputT> future : futures) {
        final int index = i++;
        future.addListener(
            new Runnable() {
              @Override
      ...
      for (ListenableFuture2<? extends InputT> future : futures) {
