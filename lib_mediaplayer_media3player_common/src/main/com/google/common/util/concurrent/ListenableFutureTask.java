...
/**
 * A {@link FutureTask} that also implements the {@link ListenableFuture2} interface. Unlike {@code
 ...
 */
@GwtIncompatible
public class ListenableFutureTask<V> extends FutureTask<V> implements ListenableFuture2<V> {
