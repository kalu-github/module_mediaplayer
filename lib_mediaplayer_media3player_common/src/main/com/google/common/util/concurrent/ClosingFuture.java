 ...
 *       block or a {@link ListenableFuture2}.
 ...
 * ListenableFuture2} that doesn't create resources that should be closed later, you can use {@link
 * #from(ListenableFuture2)} instead.
 *
 * <h3>Derived steps</h3>
 *
...
public final class ClosingFuture<V> {
  ...
  /**
   * Starts a {@link ClosingFuture} pipeline with a {@link ListenableFuture2}.
   *
   ...
   */
  public static <V> ClosingFuture<V> from(ListenableFuture2<V> future) {
   ...
   *     begins. Consider replacing code that creates {@link ListenableFuture2}s of closeable types,
   ...
   *     {@link ListenableFuture2} that doesn't create values that should be closed, use {@link
   *     ClosingFuture#from}.
   */
  @Deprecated
  // TODO(b/163345357): Widen bound to AutoCloseable once we require API Level 19.
  public static <C extends Object & Closeable> ClosingFuture<C> eventuallyClosing(
          ListenableFuture2<C> future, final Executor closingExecutor) {
    checkNotNull(closingExecutor);
  ...
  private ClosingFuture(ListenableFuture2<V> future) {
  ...
  private ClosingFuture(final AsyncClosingCallable<V> callable, Executor executor) {
    ...
    TrustedListenableFutureTask<V> task =
        TrustedListenableFutureTask.create(
            new AsyncCallable<V>() {
              @Override
              public ListenableFuture2<V> call() throws Exception {
   ...
   */
  public ListenableFuture2<?> statusFuture() {
   ...
   * the discussion in the {@link ListenableFuture2#addListener} documentation. All its warnings
  ...
  public <U> ClosingFuture<U> transform(
    ...
    AsyncFunction<V, U> applyFunction =
        new AsyncFunction<V, U>() {
          @Override
          public ListenableFuture2<U> apply(V input) throws Exception {
   ...
   *
   * <ul>
   *   <li>Use this method only when calling an API that returns a {@link ListenableFuture2} or a
   ...
   *   <li>Return a {@code ClosingFuture}. To turn a {@link ListenableFuture2} into a {@code
   *       ClosingFuture} call {@link #from(ListenableFuture2)}.
   *   <li>In case this step doesn't create new closeables, you can adapt an API that returns a
   *       {@link ListenableFuture2} to return a {@code ClosingFuture} by wrapping it with a call to
   ...
   *       DeferredCloser#eventuallyClose(Closeable, Executor)}.
   *   <li>It returns a {@link ListenableFuture2}.
   * </ul>
   *
   * <p>Example usage:
   *
   ...
   *     ListenableFuture2} with the value of a derived step
   */
  ...
  private <X extends Throwable, W extends V> ClosingFuture<V> catchingMoreGeneric(
    ...
    AsyncFunction<X, W> applyFallback =
        new AsyncFunction<X, W>() {
          @Override
          public ListenableFuture2<W> apply(X exception) throws Exception {
  ...
  private static final class CloseableList extends IdentityHashMap<Closeable, Executor>
    ...
    <V, U> ListenableFuture2<U> applyClosingFunction(
  ...
  enum State {
    ...
    /**
     * Some {@link ListenableFuture2} has a callback attached that will close the {@link
