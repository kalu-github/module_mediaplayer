...
/**
 * An {@link ExecutorService} that returns {@link ListenableFuture2} instances. To create an instance
...
public interface ListeningExecutorService extends ExecutorService {
   ...
   */
  @Override
  <T> ListenableFuture2<T> submit(Callable<T> task);
   ...
   */
  @Override
  ListenableFuture2<?> submit(Runnable task);
   ...
   */
  @Override
  <T> ListenableFuture2<T> submit(Runnable task, T result);

  /**
   * {@inheritDoc}
   *
   * <p>All elements in the returned list must be {@link ListenableFuture2} instances. The easiest
