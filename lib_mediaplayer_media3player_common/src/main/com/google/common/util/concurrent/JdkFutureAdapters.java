...
public final class JdkFutureAdapters {
  /**
   * Assigns a thread to the given {@link Future} to provide {@link ListenableFuture2} functionality.
   *
   * <p><b>Warning:</b> If the input future does not already implement {@code ListenableFuture}, the
   * returned future will emulate {@link ListenableFuture2#addListener} by taking a thread from an
   ...
   */
  public static <V> ListenableFuture2<V> listenInPoolThread(Future<V> future) {
    if (future instanceof ListenableFuture2) {
      return (ListenableFuture2<V>) future;
    }
    return new ListenableFutureAdapter<V>(future);
  }

  /**
   * Submits a blocking task for the given {@link Future} to provide {@link ListenableFuture2}
   * functionality.
   *
   * <p><b>Warning:</b> If the input future does not already implement {@code ListenableFuture}, the
   * returned future will emulate {@link ListenableFuture2#addListener} by submitting a task to the
   ...
   * @since 12.0
   */
  public static <V> ListenableFuture2<V> listenInPoolThread(Future<V> future, Executor executor) {
  ...
  /**
   * An adapter to turn a {@link Future} into a {@link ListenableFuture2}. This will wait on the
