...
@GwtCompatible
abstract class AbstractCatchingFuture2<V, X extends Throwable, F, T>
    extends FluentFuture.TrustedFuture<V> implements Runnable {
  static <V, X extends Throwable> ListenableFuture2<V> create(
  ...
  static <X extends Throwable, V> ListenableFuture2<V> create(
      ListenableFuture2<? extends V> input,
      Class<X> exceptionType,
   ...
   */
  @NullableDecl
  ListenableFuture2<? extends V> inputFuture;
  @NullableDecl Class<X> exceptionType;
  @NullableDecl F fallback;

  AbstractCatchingFuture2(
          ListenableFuture2<? extends V> inputFuture, Class<X> exceptionType, F fallback) {
  ...
  public final void run() {
    ListenableFuture2<? extends V> localInputFuture = inputFuture;
  ...
  /**
   * An {@link AbstractCatchingFuture2} that delegates to an {@link AsyncFunction} and {@link
   * #setFuture(ListenableFuture2)}.
   */
  private static final class AsyncCatchingFuture<V, X extends Throwable>
      extends AbstractCatchingFuture2<
                V, X, AsyncFunction<? super X, ? extends V>, ListenableFuture2<? extends V>> {
    AsyncCatchingFuture(
        ListenableFuture2<? extends V> input,
        Class<X> exceptionType,
        AsyncFunction<? super X, ? extends V> fallback) {
    ...
    @Override
    ListenableFuture2<? extends V> doFallback(
        AsyncFunction<? super X, ? extends V> fallback, X cause) throws Exception {
      ListenableFuture2<? extends V> replacement = fallback.apply(cause);
      checkNotNull(
          replacement,
    ...
    @Override
    void setResult(ListenableFuture2<? extends V> result) {
      setFuture(result);
    }
  }

  /**
   * An {@link AbstractCatchingFuture2} that delegates to a {@link Function} and {@link
   * #set(Object)}.
   */
  private static final class CatchingFuture<V, X extends Throwable>
      extends AbstractCatchingFuture2<V, X, Function<? super X, ? extends V>, V> {
    CatchingFuture(
        ListenableFuture2<? extends V> input,
        Class<X> exceptionType,
        Function<? super X, ? extends V> fallback) {
