...
abstract class AbstractTransformFuture<I, O, F, T> extends FluentFuture.TrustedFuture<O>
    implements Runnable {
  static <I, O> ListenableFuture2<O> create(
   ...
   */
  @NullableDecl
  ListenableFuture2<? extends I> inputFuture;
  @NullableDecl F function;

  AbstractTransformFuture(ListenableFuture2<? extends I> inputFuture, F function) {
  ...
  public final void run() {
    ListenableFuture2<? extends I> localInputFuture = inputFuture;
    ...
    if (localInputFuture.isCancelled()) {
      ...
      boolean unused =
          setFuture((ListenableFuture2<O>) localInputFuture); // Respects cancellation cause setting
      return;
    }
  ...
  private static final class AsyncTransformFuture<I, O>
      extends AbstractTransformFuture<
          I, O, AsyncFunction<? super I, ? extends O>, ListenableFuture2<? extends O>> {
    AsyncTransformFuture(
            ListenableFuture2<? extends I> inputFuture, AsyncFunction<? super I, ? extends O> function) {
      super(inputFuture, function);
    }

    @Override
    ListenableFuture2<? extends O> doTransform(
        AsyncFunction<? super I, ? extends O> function, @NullableDecl I input) throws Exception {
      ListenableFuture2<? extends O> outputFuture = function.apply(input);
      checkNotNull(
          outputFuture,
    ...
    @Override
    void setResult(ListenableFuture2<? extends O> result) {
      setFuture(result);
    }
  }
  ...
  private static final class TransformFuture<I, O>
    ...
    TransformFuture(
            ListenableFuture2<? extends I> inputFuture, Function<? super I, ? extends O> function) {
      super(inputFuture, function);
    }
