...
#define FFMPEG_CONFIGURATION "--arch=x86 --cpu=i686 --enable-yasm --enable-openssl --enable-libxml2 --disable-gpl --disable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --disable-avfilter --disable-avresample --enable-network --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vdpau --disable-videotoolbox --disable-encoders --enable-encoder=png --disable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=flv --enable-decoder=h264 --enable-decoder='mp3*' --enable-decoder=flac --disable-hwaccels --disable-muxers --enable-muxer=mp4 --disable-demuxers --enable-demuxer=aac --enable-demuxer=concat --enable-demuxer=data --enable-demuxer=flv --enable-demuxer=hls --enable-demuxer=live_flv --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=mpegps --enable-demuxer=mpegts --enable-demuxer=mpegvideo --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=h264 --enable-bsfs --disable-bsf=chomp --disable-bsf=dca_core --disable-bsf=dump_extradata --disable-bsf=hevc_mp4toannexb --disable-bsf=imx_dump_header --disable-bsf=mjpeg2jpeg --disable-bsf=mjpega_dump_header --disable-bsf=mov2textsub --disable-bsf=mp3_header_decompress --disable-bsf=mpeg4_unpack_bframes --disable-bsf=noise --disable-bsf=remove_extradata --disable-bsf=text2movsub --disable-bsf=vp9_superframe --disable-bsf=eac3_core --enable-protocols --enable-protocol=async --disable-protocol=bluray --disable-protocol=concat --disable-protocol=crypto --disable-protocol=ffrtmpcrypt --enable-protocol=ffrtmphttp --disable-protocol=gopher --disable-protocol=icecast --disable-protocol='librtmp*' --disable-protocol=libssh --disable-protocol=md5 --disable-protocol=mmsh --disable-protocol=mmst --disable-protocol='rtmp*' --disable-protocol=rtmp --disable-protocol=rtmpt --disable-protocol=rtp --disable-protocol=sctp --disable-protocol=srtp --disable-protocol=subfile --disable-protocol=unix --disable-devices --disable-filters --disable-iconv --disable-audiotoolbox --disable-videotoolbox --disable-linux-perf --disable-bzlib --enable-openssl --enable-libxml2 --enable-muxer=dash --enable-muxer=webm_dash_manifest --enable-muxer=webm_chunk --enable-demuxer=dash --enable-demuxer=webm_chunk --prefix=/home/kalu/download/ijkplayer-ffmpeg/n4.4.4/ijkplayer-k0.8.8-ff4.4.4-lite/android/contrib/build/ffmpeg-x86/output --cross-prefix=i686-linux-android- --enable-cross-compile --target-os=linux --enable-pic --disable-asm --enable-optimizations --enable-debug --enable-small --extra-cflags='-O3 -Wall -pipe -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -I/home/kalu/download/ijkplayer-ffmpeg/n4.4.4/ijkplayer-k0.8.8-ff4.4.4-lite/android/contrib/build/openssl-x86/output/include -I/home/kalu/download/ijkplayer-ffmpeg/n4.4.4/ijkplayer-k0.8.8-ff4.4.4-lite/android/contrib/build/libxml2-x86/output/include -march=atom -msse3 -ffast-math -mfpmath=sse' --extra-ldflags=' -L/home/kalu/download/ijkplayer-ffmpeg/n4.4.4/ijkplayer-k0.8.8-ff4.4.4-lite/android/contrib/build/openssl-x86/output/lib -lssl -lcrypto -L/home/kalu/download/ijkplayer-ffmpeg/n4.4.4/ijkplayer-k0.8.8-ff4.4.4-lite/android/contrib/build/libxml2-x86/output/lib -lxml2 -lz -lm '"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2023
#define FFMPEG_DATADIR "/home/kalu/download/ijkplayer-ffmpeg/n4.4.4/ijkplayer-k0.8.8-ff4.4.4-lite/android/contrib/build/ffmpeg-x86/output/share/ffmpeg"
#define AVCONV_DATADIR "/home/kalu/download/ijkplayer-ffmpeg/n4.4.4/ijkplayer-k0.8.8-ff4.4.4-lite/android/contrib/build/ffmpeg-x86/output/share/ffmpeg"
