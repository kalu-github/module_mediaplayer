 ...
 */
int ijk_av_fifo_generic_peek_at(IjkFifoBuffer *f, void *dest, int offset, int buf_size,
 ...
 */
int
ijk_av_fifo_generic_write(IjkFifoBuffer *f, void *src, int size, int (*func)(void *, void *, int));
