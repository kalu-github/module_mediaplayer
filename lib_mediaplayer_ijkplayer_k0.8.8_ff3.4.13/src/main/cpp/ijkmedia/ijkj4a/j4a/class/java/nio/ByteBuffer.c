...
jobject J4AC_java_nio_ByteBuffer__allocate(JNIEnv *env, jint capacity) {
    return (*env)->CallStaticObjectMethod(env, class_J4AC_java_nio_ByteBuffer.id,
                                          class_J4AC_java_nio_ByteBuffer.method_allocate, capacity);
}
...
jobject J4AC_java_nio_ByteBuffer__allocateDirect(JNIEnv *env, jint capacity) {
    return (*env)->CallStaticObjectMethod(env, class_J4AC_java_nio_ByteBuffer.id,
                                          class_J4AC_java_nio_ByteBuffer.method_allocateDirect,
                                          capacity);
}
...
jobject
J4AC_java_nio_ByteBuffer__allocateDirect__asGlobalRef__catchAll(JNIEnv *env, jint capacity) {
    jobject ret_object = NULL;
...
jobject J4AC_java_nio_ByteBuffer__limit(JNIEnv *env, jobject thiz, jint newLimit) {
    return (*env)->CallObjectMethod(env, thiz, class_J4AC_java_nio_ByteBuffer.method_limit,
                                    newLimit);
}
...
jobject
J4AC_java_nio_ByteBuffer__limit__asGlobalRef__catchAll(JNIEnv *env, jobject thiz, jint newLimit) {
    jobject ret_object = NULL;
...
int J4A_loadClass__J4AC_java_nio_ByteBuffer(JNIEnv *env) {
    ...
    class_J4AC_java_nio_ByteBuffer.method_allocate = J4A_GetStaticMethodID__catchAll(env, class_id,
                                                                                     name, sign);
    ...
    name = "allocateDirect";
    sign = "(I)Ljava/nio/ByteBuffer;";
    class_J4AC_java_nio_ByteBuffer.method_allocateDirect = J4A_GetStaticMethodID__catchAll(env,
                                                                                           class_id,
                                                                                           name,
                                                                                           sign);
    ...
    class_J4AC_java_nio_ByteBuffer.method_limit = J4A_GetMethodID__catchAll(env, class_id, name,
                                                                            sign);
