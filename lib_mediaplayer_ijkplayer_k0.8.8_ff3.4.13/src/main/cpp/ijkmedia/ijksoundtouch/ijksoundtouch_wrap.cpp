...
extern "C" int
ijk_soundtouch_translate(void *handle, short *data, float speed, float pitch, int len,
...
int ijk_soundtouch_translate(void *handle, short *data, float speed, float pitch, int len,
                             int bytes_per_sample, int n_channel, int n_sampleRate) {
