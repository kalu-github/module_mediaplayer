...
public final class AudioExoPlayer2 extends AudioBasePlayer {
    ...
    public AudioExoPlayer2(@NonNull AudioPlayerApi playerApi, @NonNull AudioKernelApiEvent eventApi) {
    ...
    public void initOptionsExo(@NonNull Context context, @NonNull ExoPlayer.Builder exoBuilder) {
        try {
            ...
            MPLogUtil.log("AudioExoPlayer2 => initOptionsExo => " + e.getMessage());
        }
    }
...
//        }
    ...
    public void startDecoder(@NonNull Context context, @NonNull String url, @NonNull boolean prepareAsync) {
        ...
        try {
            ...
            MediaSource mediaSource = buildMediaSource(context, url, null, PlayerType.CacheType.NONE, cacheMax, cacheDir);
