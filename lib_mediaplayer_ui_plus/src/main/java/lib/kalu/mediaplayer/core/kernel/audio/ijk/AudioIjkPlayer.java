...
public final class AudioIjkPlayer extends AudioBasePlayer {
    ...
    public AudioIjkPlayer(@NonNull boolean useMediaCodec, @NonNull AudioPlayerApi musicApi, @NonNull AudioKernelApiEvent eventApi) {
    ...
    public void initOptionsIjk() {
        ...
        try {
            ...
            MPLogUtil.log("AudioIjkPlayer => initOptionsIjk => OPT_CATEGORY_PLAYER => " + e.getMessage());
        }
...
//            mIjkPlayer.setOption(format, "fflags", "nobuffer");  // 起播seek会失效
            ...
            MPLogUtil.log("AudioIjkPlayer => initOptionsIjk => OPT_CATEGORY_FORMAT => " + e.getMessage());
        }
        try {
            int codec = IjkMediaPlayer.OPT_CATEGORY_CODEC;
            mIjkPlayer.setOption(codec, "skip_loop_filter", 48);
        } catch (Exception e) {
            MPLogUtil.log("AudioIjkPlayer => initOptionsIjk => OPT_CATEGORY_CODEC => " + e.getMessage());
        }
