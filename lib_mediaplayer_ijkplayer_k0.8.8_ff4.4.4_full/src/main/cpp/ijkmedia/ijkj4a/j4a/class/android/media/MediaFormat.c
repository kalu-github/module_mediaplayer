...
jobject J4AC_android_media_MediaFormat__MediaFormat(JNIEnv *env) {
    return (*env)->NewObject(env, class_J4AC_android_media_MediaFormat.id,
...
jobject J4AC_android_media_MediaFormat__createVideoFormat(JNIEnv *env, jstring mime, jint width,
                                                          jint height) {
    return (*env)->CallStaticObjectMethod(env, class_J4AC_android_media_MediaFormat.id,
                                          class_J4AC_android_media_MediaFormat.method_createVideoFormat,
                                          mime, width, height);
}

jobject
J4AC_android_media_MediaFormat__createVideoFormat__catchAll(JNIEnv *env, jstring mime, jint width,
                                                            jint height) {
    jobject ret_object = J4AC_android_media_MediaFormat__createVideoFormat(env, mime, width,
                                                                           height);
    if (J4A_ExceptionCheck__catchAll(env) || !ret_object) {
        return NULL;
    }
...
jobject
J4AC_android_media_MediaFormat__createVideoFormat__asGlobalRef__catchAll(JNIEnv *env, jstring mime,
                                                                         jint width, jint height) {
    jobject ret_object = NULL;
    jobject local_object = J4AC_android_media_MediaFormat__createVideoFormat__catchAll(env, mime,
                                                                                       width,
                                                                                       height);
    if (J4A_ExceptionCheck__catchAll(env) || !local_object) {
        ret_object = NULL;
...
jobject
J4AC_android_media_MediaFormat__createVideoFormat__withCString(JNIEnv *env, const char *mime_cstr__,
                                                               jint width, jint height) {
    jobject ret_object = NULL;
    jstring mime = NULL;
...
jobject J4AC_android_media_MediaFormat__createVideoFormat__withCString__catchAll(JNIEnv *env,
                                                                                 const char *mime_cstr__,
                                                                                 jint width,
                                                                                 jint height) {
    jobject ret_object = NULL;
    jstring mime = NULL;
    ...
    ret_object = J4AC_android_media_MediaFormat__createVideoFormat__catchAll(env, mime, width,
                                                                             height);
    if (J4A_ExceptionCheck__catchAll(env) || !ret_object) {
        ret_object = NULL;
        goto fail;
...
jobject
J4AC_android_media_MediaFormat__createVideoFormat__withCString__asGlobalRef__catchAll(JNIEnv *env,
                                                                                      const char *mime_cstr__,
                                                                                      jint width,
                                                                                      jint height) {
    jobject ret_object = NULL;
...
jint J4AC_android_media_MediaFormat__getInteger(JNIEnv *env, jobject thiz, jstring name) {
    return (*env)->CallIntMethod(env, thiz, class_J4AC_android_media_MediaFormat.method_getInteger,
                                 name);
}
...
jint J4AC_android_media_MediaFormat__getInteger__withCString(JNIEnv *env, jobject thiz,
...
jint J4AC_android_media_MediaFormat__getInteger__withCString__catchAll(JNIEnv *env, jobject thiz,
                                                                       const char *name_cstr__) {
    jint ret_value = 0;
    jstring name = NULL;
...
void
J4AC_android_media_MediaFormat__setInteger(JNIEnv *env, jobject thiz, jstring name, jint value) {
    (*env)->CallVoidMethod(env, thiz, class_J4AC_android_media_MediaFormat.method_setInteger, name,
                           value);
}

void J4AC_android_media_MediaFormat__setInteger__catchAll(JNIEnv *env, jobject thiz, jstring name,
                                                          jint value) {
    J4AC_android_media_MediaFormat__setInteger(env, thiz, name, value);
    J4A_ExceptionCheck__catchAll(env);
}

void J4AC_android_media_MediaFormat__setInteger__withCString(JNIEnv *env, jobject thiz,
                                                             const char *name_cstr__, jint value) {
    jstring name = NULL;
...
void J4AC_android_media_MediaFormat__setInteger__withCString__catchAll(JNIEnv *env, jobject thiz,
                                                                       const char *name_cstr__,
                                                                       jint value) {
    jstring name = NULL;
...
void J4AC_android_media_MediaFormat__setByteBuffer(JNIEnv *env, jobject thiz, jstring name,
                                                   jobject bytes) {
    (*env)->CallVoidMethod(env, thiz, class_J4AC_android_media_MediaFormat.method_setByteBuffer,
                           name, bytes);
}

void
J4AC_android_media_MediaFormat__setByteBuffer__catchAll(JNIEnv *env, jobject thiz, jstring name,
                                                        jobject bytes) {
    J4AC_android_media_MediaFormat__setByteBuffer(env, thiz, name, bytes);
    J4A_ExceptionCheck__catchAll(env);
}

void J4AC_android_media_MediaFormat__setByteBuffer__withCString(JNIEnv *env, jobject thiz,
                                                                const char *name_cstr__,
                                                                jobject bytes) {
    jstring name = NULL;
...
void J4AC_android_media_MediaFormat__setByteBuffer__withCString__catchAll(JNIEnv *env, jobject thiz,
                                                                          const char *name_cstr__,
                                                                          jobject bytes) {
    jstring name = NULL;
...
int J4A_loadClass__J4AC_android_media_MediaFormat(JNIEnv *env) {
    ...
    name = "<init>";
    sign = "()V";
    class_J4AC_android_media_MediaFormat.constructor_MediaFormat = J4A_GetMethodID__catchAll(env,
                                                                                             class_id,
                                                                                             name,
                                                                                             sign);
    ...
    class_J4AC_android_media_MediaFormat.method_createVideoFormat = J4A_GetStaticMethodID__catchAll(
    ...
    class_J4AC_android_media_MediaFormat.method_getInteger = J4A_GetMethodID__catchAll(env,
                                                                                       class_id,
                                                                                       name, sign);
    ...
    class_J4AC_android_media_MediaFormat.method_setInteger = J4A_GetMethodID__catchAll(env,
                                                                                       class_id,
                                                                                       name, sign);
    ...
    class_J4AC_android_media_MediaFormat.method_setByteBuffer = J4A_GetMethodID__catchAll(env,
                                                                                          class_id,
                                                                                          name,
                                                                                          sign);
