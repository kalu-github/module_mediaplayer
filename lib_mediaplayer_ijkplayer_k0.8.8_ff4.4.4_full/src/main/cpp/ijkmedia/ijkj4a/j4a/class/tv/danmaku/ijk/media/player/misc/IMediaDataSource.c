...
jint J4AC_tv_danmaku_ijk_media_player_misc_IMediaDataSource__readAt(JNIEnv *env, jobject thiz,
                                                                    jlong position,
                                                                    jbyteArray buffer, jint offset,
                                                                    jint size) {
    return (*env)->CallIntMethod(env, thiz,
                                 class_J4AC_tv_danmaku_ijk_media_player_misc_IMediaDataSource.method_readAt,
                                 position, buffer, offset, size);
}

jint
J4AC_tv_danmaku_ijk_media_player_misc_IMediaDataSource__readAt__catchAll(JNIEnv *env, jobject thiz,
                                                                         jlong position,
                                                                         jbyteArray buffer,
                                                                         jint offset, jint size) {
    jint ret_value = J4AC_tv_danmaku_ijk_media_player_misc_IMediaDataSource__readAt(env, thiz,
                                                                                    position,
                                                                                    buffer, offset,
                                                                                    size);
...
jlong J4AC_tv_danmaku_ijk_media_player_misc_IMediaDataSource__getSize(JNIEnv *env, jobject thiz) {
    return (*env)->CallLongMethod(env, thiz,
                                  class_J4AC_tv_danmaku_ijk_media_player_misc_IMediaDataSource.method_getSize);
}

jlong J4AC_tv_danmaku_ijk_media_player_misc_IMediaDataSource__getSize__catchAll(JNIEnv *env,
                                                                                jobject thiz) {
...
void J4AC_tv_danmaku_ijk_media_player_misc_IMediaDataSource__close(JNIEnv *env, jobject thiz) {
    (*env)->CallVoidMethod(env, thiz,
                           class_J4AC_tv_danmaku_ijk_media_player_misc_IMediaDataSource.method_close);
}

void
J4AC_tv_danmaku_ijk_media_player_misc_IMediaDataSource__close__catchAll(JNIEnv *env, jobject thiz) {
...
int J4A_loadClass__J4AC_tv_danmaku_ijk_media_player_misc_IMediaDataSource(JNIEnv *env) {
    ...
    class_J4AC_tv_danmaku_ijk_media_player_misc_IMediaDataSource.id = J4A_FindClass__asGlobalRef__catchAll(
            env, sign);
    if (class_J4AC_tv_danmaku_ijk_media_player_misc_IMediaDataSource.id == NULL)
        goto fail;
    ...
    name = "readAt";
    sign = "(J[BII)I";
    class_J4AC_tv_danmaku_ijk_media_player_misc_IMediaDataSource.method_readAt = J4A_GetMethodID__catchAll(
    ...
    name = "getSize";
    sign = "()J";
    class_J4AC_tv_danmaku_ijk_media_player_misc_IMediaDataSource.method_getSize = J4A_GetMethodID__catchAll(
            env, class_id, name, sign);
    ...
    name = "close";
    sign = "()V";
    class_J4AC_tv_danmaku_ijk_media_player_misc_IMediaDataSource.method_close = J4A_GetMethodID__catchAll(
            env, class_id, name, sign);
