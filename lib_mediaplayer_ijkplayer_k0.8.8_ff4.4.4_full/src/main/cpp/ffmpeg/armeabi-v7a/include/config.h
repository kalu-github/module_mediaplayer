...
#define FFMPEG_CONFIGURATION "--arch=arm --cpu=cortex-a8 --enable-neon --enable-thumb --enable-openssl --enable-libxml2 --disable-gpl --disable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --disable-avfilter --disable-avresample --enable-network --disable-dxva2 --disable-vaapi --disable-vdpau --disable-encoders --disable-hwaccels --disable-muxers --disable-devices --disable-iconv --enable-protocol=async --disable-linux-perf --enable-openssl --enable-libxml2 --enable-muxer=dash --enable-muxer=webm_dash_manifest --enable-muxer=webm_chunk --enable-demuxer=dash --enable-demuxer=webm_chunk --prefix=/home/kalu/download/ijkplayer-ffmpeg/n4.4.4/ijkplayer-k0.8.8-ff4.4.4-full/android/contrib/build/ffmpeg-armv7a/output --cross-prefix=arm-linux-androideabi- --enable-cross-compile --target-os=linux --enable-pic --enable-asm --enable-inline-asm --enable-optimizations --enable-debug --enable-small --extra-cflags='-O3 -Wall -pipe -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -I/home/kalu/download/ijkplayer-ffmpeg/n4.4.4/ijkplayer-k0.8.8-ff4.4.4-full/android/contrib/build/openssl-armv7a/output/include -I/home/kalu/download/ijkplayer-ffmpeg/n4.4.4/ijkplayer-k0.8.8-ff4.4.4-full/android/contrib/build/libxml2-armv7a/output/include -march=armv7-a -mcpu=cortex-a8 -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb' --extra-ldflags=' -L/home/kalu/download/ijkplayer-ffmpeg/n4.4.4/ijkplayer-k0.8.8-ff4.4.4-full/android/contrib/build/openssl-armv7a/output/lib -lssl -lcrypto -L/home/kalu/download/ijkplayer-ffmpeg/n4.4.4/ijkplayer-k0.8.8-ff4.4.4-full/android/contrib/build/libxml2-armv7a/output/lib -lxml2 -lz -lm -Wl,--fix-cortex-a8'"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2023
#define FFMPEG_DATADIR "/home/kalu/download/ijkplayer-ffmpeg/n4.4.4/ijkplayer-k0.8.8-ff4.4.4-full/android/contrib/build/ffmpeg-armv7a/output/share/ffmpeg"
#define AVCONV_DATADIR "/home/kalu/download/ijkplayer-ffmpeg/n4.4.4/ijkplayer-k0.8.8-ff4.4.4-full/android/contrib/build/ffmpeg-armv7a/output/share/ffmpeg"
