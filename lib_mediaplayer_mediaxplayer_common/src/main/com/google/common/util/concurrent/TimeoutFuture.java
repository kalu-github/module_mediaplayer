...
final class TimeoutFuture<V> extends FluentFuture.TrustedFuture<V> {
  static <V> ListenableFuture2<V> create(
  ...
  @NullableDecl private ListenableFuture2<V> delegateRef;
  @NullableDecl private ScheduledFuture<?> timer;

  private TimeoutFuture(ListenableFuture2<V> delegate) {
  ...
  private static final class Fire<V> implements Runnable {
    ...
    public void run() {
      ...
      ListenableFuture2<V> delegate = timeoutFuture.delegateRef;
      if (delegate == null) {
        return;
      }
  ...
  protected String pendingToString() {
    ListenableFuture2<? extends V> localInputFuture = delegateRef;
