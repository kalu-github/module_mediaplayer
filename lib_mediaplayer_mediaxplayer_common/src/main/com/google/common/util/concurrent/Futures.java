 ...
 *
 * <p>Many of these methods use the {@link ListenableFuture2} API; consult the Guava User Guide
 * article on <a href="https://github.com/google/guava/wiki/ListenableFutureExplained">{@code
 * ListenableFuture}</a>.
 *
 * <p>The main purpose of {@code ListenableFuture} is to help you chain together a graph of
 * asynchronous operations. You can chain them together manually with calls to methods like {@link
 * Futures#transform(ListenableFuture2, Function, Executor) Futures.transform}, but you will often
...
public final class Futures extends GwtFuturesCatchingSpecialization {
   ...
   */
  public static <V> ListenableFuture2<V> immediateFuture(@NullableDecl V value) {
    if (value == null) {
      // This cast is safe because null is assignable to V for all V (i.e. it is bivariant)
      @SuppressWarnings("unchecked")
      ListenableFuture2<V> typedNull = (ListenableFuture2<V>) ImmediateFuture.NULL;
      return typedNull;
    }
   ...
   */
  @SuppressWarnings("unchecked")
  public static ListenableFuture2<Void> immediateVoidFuture() {
    return (ListenableFuture2<Void>) ImmediateFuture.NULL;
  }
   ...
   */
  public static <V> ListenableFuture2<V> immediateFailedFuture(Throwable throwable) {
   ...
   * @since 14.0
   */
  public static <V> ListenableFuture2<V> immediateCancelledFuture() {
   ...
   */
  @Beta
  public static <O> ListenableFuture2<O> submit(Callable<O> callable, Executor executor) {
   ...
   */
  @Beta
  public static ListenableFuture2<Void> submit(Runnable runnable, Executor executor) {
   ...
   */
  @Beta
  public static <O> ListenableFuture2<O> submitAsync(AsyncCallable<O> callable, Executor executor) {
    TrustedListenableFutureTask<O> task = TrustedListenableFutureTask.create(callable);
    executor.execute(task);
    return task;
  }
  ...
  public static <O> ListenableFuture2<O> scheduleAsync(
  ...
  public static <V, X extends Throwable> ListenableFuture2<V> catching(
      ListenableFuture2<? extends V> input,
      Class<X> exceptionType,
      Function<? super X, ? extends V> fallback,
      Executor executor) {
    return AbstractCatchingFuture2.create(input, exceptionType, fallback, executor);
  }
  ...
  @Beta
  @Partially.GwtIncompatible("AVAILABLE but requires exceptionType to be Throwable.class")
  public static <V, X extends Throwable> ListenableFuture2<V> catchingAsync(
      ListenableFuture2<? extends V> input,
      Class<X> exceptionType,
  ...
  @GwtIncompatible // java.util.concurrent.ScheduledExecutorService
  @SuppressWarnings("GoodTime") // should accept a java.time.Duration
  public static <V> ListenableFuture2<V> withTimeout(
      ListenableFuture2<V> delegate,
      long time,
      TimeUnit unit,
   ...
   */
  @Beta
  public static <I, O> ListenableFuture2<O> transformAsync(
      ListenableFuture2<I> input,
   ...
   */
  @Beta
  public static <I, O> ListenableFuture2<O> transform(
          ListenableFuture2<I> input, Function<? super I, ? extends O> function, Executor executor) {
    return AbstractTransformFuture.create(input, function, executor);
  }

  /**
   * Like {@link #transform(ListenableFuture2, Function, Executor)} except that the transformation
   ...
   *
   * <p>This differs from {@link #successfulAsList(ListenableFuture2[])} in that it will return a
  ...
  @Beta
  @SafeVarargs
  public static <V> ListenableFuture2<List<V>> allAsList(ListenableFuture2<? extends V>... futures) {
   ...
   */
  @Beta
  public static <V> ListenableFuture2<List<V>> allAsList(
      Iterable<? extends ListenableFuture2<? extends V>> futures) {
    return new ListFuture<V>(ImmutableList.copyOf(futures), true);
  }
  ...
  @Beta
  @SafeVarargs
  public static <V> FutureCombiner<V> whenAllComplete(ListenableFuture2<? extends V>... futures) {
  ...
  @Beta
  @SafeVarargs
  public static <V> FutureCombiner<V> whenAllSucceed(ListenableFuture2<? extends V>... futures) {
  ...
  public static final class FutureCombiner<V> {
    ...
    private final ImmutableList<ListenableFuture2<? extends V>> futures;

    private FutureCombiner(
        boolean allMustSucceed, ImmutableList<ListenableFuture2<? extends V>> futures) {
      this.allMustSucceed = allMustSucceed;
      this.futures = futures;
    }

    /**
     * Creates the {@link ListenableFuture2} which will return the result of calling {@link
     ...
     */
    public <C> ListenableFuture2<C> callAsync(AsyncCallable<C> combiner, Executor executor) {
    ...
    public <C> ListenableFuture2<C> call(Callable<C> combiner, Executor executor) {
      return new CombinedFuture<C>(futures, allMustSucceed, executor, combiner);
    }

    /**
     * Creates the {@link ListenableFuture2} which will return the result of running {@code combiner}
     ...
     * @since 23.6
     */
    public ListenableFuture2<?> run(final Runnable combiner, Executor executor) {
      return call(
          new Callable<Void>() {
            @Override
   ...
   */
  @Beta
  public static <V> ListenableFuture2<V> nonCancellationPropagating(ListenableFuture2<V> future) {
    if (future.isDone()) {
      return future;
    }
  ...
  private static final class NonCancellationPropagatingFuture<V>
    ...
    private ListenableFuture2<V> delegate;

    NonCancellationPropagatingFuture(final ListenableFuture2<V> delegate) {
    ...
    public void run() {
      ...
      ListenableFuture2<V> localDelegate = delegate;
   ...
   * <p>The list of results is in the same order as the input list.
   *
   * <p>This differs from {@link #allAsList(ListenableFuture2[])} in that it's tolerant of failed
  ...
  @Beta
  @SafeVarargs
  public static <V> ListenableFuture2<List<V>> successfulAsList(
      ListenableFuture2<? extends V>... futures) {
   ...
   */
  @Beta
  public static <T> ImmutableList<ListenableFuture2<T>> inCompletionOrder(
      Iterable<? extends ListenableFuture2<? extends T>> futures) {
    // Can't use Iterables.toArray because it's not gwt compatible
    final Collection<ListenableFuture2<? extends T>> collection;
    if (futures instanceof Collection) {
      collection = (Collection<ListenableFuture2<? extends T>>) futures;
    } else {
      collection = ImmutableList.copyOf(futures);
    }
    @SuppressWarnings("unchecked")
    ListenableFuture2<? extends T>[] copy =
        (ListenableFuture2<? extends T>[])
            collection.toArray(new ListenableFuture2[collection.size()]);
    ...
    @SuppressWarnings("unchecked")
    ImmutableList<ListenableFuture2<T>> delegatesCast = (ImmutableList) delegates;
  ...
  private static final class InCompletionOrderState<T> {
    ...
    private final ListenableFuture2<? extends T>[] inputFutures;
    private volatile int delegateIndex = 0;

    private InCompletionOrderState(ListenableFuture2<? extends T>[] inputFutures) {
    ...
    private void recordInputCompletion(
      ...
      ListenableFuture2<? extends T> inputFuture = inputFutures[inputFutureIndex];
    ...
    private void recordCompletion() {
      if (incompleteOutputCount.decrementAndGet() == 0 && wasCancelled) {
        for (ListenableFuture2<?> toCancel : inputFutures) {
          if (toCancel != null) {
   ...
   * ListenableFuture2#addListener addListener}.
   *
  ...
  public static <V> void addCallback(
      final ListenableFuture2<V> future,
  ...
  /** See {@link #addCallback(ListenableFuture2, FutureCallback, Executor)} for behavioral notes. */
