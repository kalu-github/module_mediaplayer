 ...
 * asynchronous operations. You can chain them together manually with calls to methods like , but you will often find it easier to use a framework. Frameworks automate the
 ...
 *   <li>If you manually call  or a similar method,
...
public interface ListenableFuture2<V> extends Future<V> {
  /**
