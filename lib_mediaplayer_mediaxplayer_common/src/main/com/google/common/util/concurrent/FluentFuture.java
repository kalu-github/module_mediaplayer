...
/**
 * A {@link ListenableFuture2} that supports fluent chains of operations. For example:
 *
 * <pre>{@code
 ...
 * own subclass of {@link ListenableFuture2}, complete with a method like {@link #from} to adapt an
...
public abstract class FluentFuture<V> extends GwtFluentFutureCatchingSpecialization<V> {
   ...
   */
  public static <V> FluentFuture<V> from(ListenableFuture2<V> future) {
