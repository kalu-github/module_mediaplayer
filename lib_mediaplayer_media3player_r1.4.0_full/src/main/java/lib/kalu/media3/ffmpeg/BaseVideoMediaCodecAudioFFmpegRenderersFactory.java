...
public class BaseVideoMediaCodecAudioFFmpegRenderersFactory extends BaseRenderersFactory {

    public BaseVideoMediaCodecAudioFFmpegRenderersFactory(Context context) {
        super(context);
